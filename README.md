...
* Other recurrent architectures discussed in previous work

While these architectures provide useful computational principles, the primary focus of this project will be on biologically constrained recurrent networks.
